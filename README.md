...
![URL Checker UI](docs/preview.png)

## Как использовать

1. Вставьте URL-адреса в поле — по одному на строку
2. Нажмите **Запустить проверку** — задание создаётся мгновенно
3. В правой панели появится прогресс и результаты по каждому URL в реальном времени
4. Чтобы остановить выполнение, нажмите **Отменить задание**
5. Все запущенные задания видны в списке слева — можно переключаться между ними
